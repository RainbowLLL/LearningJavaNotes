...
3. 这个特征并非Java所特有，很多其它的编程语言都有这一机制，比如在C++中，你可以用 ==extern== 告知C++编译器去调用一个C的函数。
...
![image-20200706164139252](https://imgconvert.csdnimg.cn/aHR0cDovL2hleWdvLm9zcy1jbi1zaGFuZ2hhaS5hbGl5dW5jcy5jb20vaW1hZ2VzL2ltYWdlLTIwMjAwNzA2MTY0MTM5MjUyLnBuZw?x-oss-process=image/format,png)
